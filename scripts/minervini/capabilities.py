...
CAPABILITIES = {
    ...
    for item in [
        ...
        _capability(
            ...
            status_meanings={"ok": "A segmentation the detector will vouch for.", "partial": "Completed price history stops before the requested session.", "unavailable": "No segmentation this capability will stand behind: completed price history is unavailable, neighbouring parameter values disagree, a session inside the base both extended and reversed a move, or the history segments into no base. The reason names which. Not needs_input, because the parameters are deliberately out of the caller's reach and no argument would change the answer."},
