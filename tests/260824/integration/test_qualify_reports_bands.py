...
class QualifyBandReportingTests(unittest.TestCase):
    ...
    def test_a_standard_route_ticker_reports_no_primary_base_band(self) -> None:
        ...
        long_history = rows_snapshot(frame, provider="fixture-prices", retrieved_at=datetime(2026, 1, 2, tzinfo=timezone.utc), as_of=date.fromisoformat(AS_OF), coverage={"completed_only": True})
        payload = execute(
            "ticker.qualify",
