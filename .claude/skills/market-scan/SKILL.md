...
- Use same-industry peer comparison on promising leaders to establish current classification, stable identity, and relative leadership.
...
- Discovery language stops at ranked leader, watch candidate, and setup-ready. The final verdict comes from the risk reducer, never from a strong screen.
...
For each candidate, show ticker, current industry identity, discovery origin, eligibility state, exact failed or missing gates, why it merits attention, and the observable condition for promotion or removal.
