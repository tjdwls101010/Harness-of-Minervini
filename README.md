...
The always-loaded constitution holds scope, immutable gates, risk discipline, data integrity, and response standards. The two compact skills contain task judgment without duplicating flags. The capability registry drives listing, description, detailed help, and 18 versioned schemas. Providers and pure reducers stay separate so transport failure, missing facts, deterministic failure, and qualitative ambiguity cannot collapse into one vague score.
